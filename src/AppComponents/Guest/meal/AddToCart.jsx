        ...
        <div>
            ...
            >
                <DialogTitle id="alert-dialog-title">
                    <h5 style={{color: '#ff7417'}} className="modal-title" id="exampleModalCenterTitle">
                        <Naira>{price}</Naira>
                    </h5>
                </DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-cart">                                
                        <div className="pr-3">
                            ...
                            <div className="mt-3">
                                <label for="additional-request" style={{color: "black"}}>Additional Request</label>
                            ...
                            <div onClick={handleAdd} className="mt-3">
                                <button data-dismiss="modal" aria-label="Close" className="btn btn-md btn-block" style={{backgroundColor: "#ff7417", color: "white"}}>ADD TO CART</button>
                            </div>
                        </div>
                    </DialogContentText>
                </DialogContent>
